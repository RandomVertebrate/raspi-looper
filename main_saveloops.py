...
#opening wave files for recording for troubleshooting
rec_files = [wave.open('track1.wav', 'wb'), wave.open('track2.wav', 'wb'), wave.open('track3.wav', 'wb'), wave.open('track4.wav', 'wb')]
...
#writing audio to files for troubleshooting
for i in range(4):
    rec_files[i].writeframes(loops[i].audio[:loops[i].length, :])
    rec_files[i].close()
